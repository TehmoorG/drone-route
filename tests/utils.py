...
def mock_zones():
    ...
    avoidance_zone = Polygon([(-0.20, 5.59), (-0.16, 5.59), (-0.16, 5.63), (-0.20, 5.63)])
...
def create_test_graph():
    ...
    G.add_node(1, pos=(-0.181442428851426, 5.590547823304689), name="Charging Station 204")
    G.add_node(2, pos=(-0.203249626337936, 5.611922849863589), name="Charging Station 139")
